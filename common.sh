...
mongo --host mongodb-dev.tejesh.cloud <${app_path}/schema/${component}.js &>>${logfile}
status
}
...
mysql_schema()
{
  ...
  mysql -h mysql-dev.tejesh.cloud -uroot -pRoboShop@1 <${app_path}/schema/shipping.sql &>>${logfile}
  status
}
